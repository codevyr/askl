...
impl Index {
    ...
    ///
    /// When the overlay is non-empty, ephemeral instances and refs are included
    /// via the parameterized CTE prefix (overlay params $1–$18, instance_ids $19).
    /// When the overlay is empty, the static CTE prefix is used (no overlay params,
    /// instance_ids $1).
    pub async fn find_edges_between(
        ...
        let sym = &overlay.symbols;
        let inst = &overlay.instances;
        let refs = &overlay.refs;
        diesel::sql_query(sql)
            // Overlay symbols ($1–$7)
            .bind::<diesel::sql_types::Array<diesel::sql_types::BigInt>, _>(&sym.ids)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Text>, _>(&sym.names)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Text>, _>(&sym.paths)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Integer>, _>(&sym.project_ids)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Integer>, _>(&sym.types)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Nullable<diesel::sql_types::Integer>>, _>(&sym.scopes)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Text>, _>(&sym.leaf_names)
            // Overlay instances ($8–$13)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Integer>, _>(&inst.ids)
            .bind::<diesel::sql_types::Array<diesel::sql_types::BigInt>, _>(&inst.symbols)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Integer>, _>(&inst.object_ids)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Integer>, _>(&inst.offset_starts)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Integer>, _>(&inst.offset_ends)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Integer>, _>(&inst.types)
            // Overlay refs ($14–$18)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Integer>, _>(&refs.ids)
            .bind::<diesel::sql_types::Array<diesel::sql_types::BigInt>, _>(&refs.to_symbols)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Integer>, _>(&refs.from_objects)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Integer>, _>(&refs.from_offset_starts)
            .bind::<diesel::sql_types::Array<diesel::sql_types::Integer>, _>(&refs.from_offset_ends)
